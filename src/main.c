...
const bagl_element_t ui_request_change_path_approval_blue[] = {
    ...
    UI_BLUE_TEXT(0, 0, 297, 320, vars.tmp_warning.bip44_change_path, BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX, BAGL_FONT_ALIGNMENT_CENTER, BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 314, 320, vars.tmp_warning.bip44_change_path+30, BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX, BAGL_FONT_ALIGNMENT_CENTER, BLACK, COLOR_BG_1),
...
const bagl_element_t ui_request_change_path_approval_nanos[] = {
    ...
    UI_NANOS_SCROLLING_TEXT(0xF3, 15, 26, 98, vars.tmp_warning.bip44_change_path, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
...
void ui_message_signature_blue_init(void) {
    ...
    //snprintf(vars.tmp.fullAmount, 65, "%.*H", 32, vars.tmp.fullAddress); // FIXER ... au milieu du hash et REMOVE OTO COMMENT ET COMMIT ET PUSH
