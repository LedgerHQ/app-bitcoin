...
// "ACP" = ANYONECANPAY: the full name wraps on the review and overflows the Nano screen.
...
// "registered" = a registered policy. The type also keeps this "To" distinct from output "To".
