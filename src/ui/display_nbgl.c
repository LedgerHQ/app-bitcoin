...
// "ACP" abbreviates ANYONECANPAY: the full name wraps to two lines on the review
// (and overflows the narrow Nano screen). ACP is the well-known shorthand for the
// audience that opts into non-standard sighash signing.
const char GA_SIGHASH_ACP_ALL[] = "ACP | ALL";
const char GA_SIGHASH_ACP_NONE[] = "ACP | NONE";
const char GA_SIGHASH_ACP_SINGLE[] = "ACP | SINGLE";
