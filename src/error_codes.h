...
// An input declares a required lock time whose value is out of range: a
// PSBT_IN_REQUIRED_HEIGHT_LOCKTIME must be in [1, 499999999], and a PSBT_IN_REQUIRED_TIME_LOCKTIME
// must be at least 500000000.
