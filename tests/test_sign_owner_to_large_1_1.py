...
def test_sign_p2pkh_accept(cmd):
    ...
    vout = transaction.PartialTxOutput(value=0, scriptpubkey=b'v\xa9\x14\x970\xc9}\xea\xed\xf7}\x8d\x9cpzPk\xcaK\xab\xad\xafi\x88\xac\xc0\x15rvno\x21SCAMCOINSCAMCOINSCAMCOINSCAMCOIN!u')
