...
from ledger_bitcoin import Client, WalletPolicy, PartialSignature
...
def test_sign_psbt_singlesig_wpkh_1to2(navigator: Navigator, firmware: Firmware, client: RaggerClient, test_name: str):
...
def test_sign_psbt_singlesig_wpkh_2to2(navigator: Navigator, firmware: Firmware, client: RaggerClient, test_name: str):
