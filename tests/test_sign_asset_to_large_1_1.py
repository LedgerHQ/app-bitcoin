...
def test_sign_p2pkh_accept(cmd):
    ...
    vout = transaction.PartialTxOutput(value=0, scriptpubkey=b'v\xa9\x14\x970\xc9}\xea\xed\xf7}\x8d\x9cpzPk\xcaK\xab\xad\xafi\x88\xac\xc0\x15rvnt\x21SCAMCOINSCAMCOINSCAMCOINSCAMCOIN1\x00\xa3\xe1\x11\x00\x00\x00\x00u')
