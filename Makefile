...
# NavCoin
DEFINES   += COIN_P2PKH_VERSION=53 COIN_P2SH_VERSION=85 COIN_FAMILY=1 COIN_COINID=\"NavCoin\" COIN_COINID_HEADER=\"NAVCOIN\" COIN_COLOR_HDR=0xB553FC COIN_COLOR_DB=0xDAA6FF COIN_COINID_NAME=\"NavCoin\" COIN_COINID_SHORT=\"NAV\" COIN_KIND=COIN_KIND_NAV
APPNAME ="NavCoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, horizen, komodo, stratis, peercoin, pivx, viacoin, vertcoin, stealth, digibyte, qtum, bitcoin_private, zcoin, gamecredits, zclassic, xsn, nix, navcoin)
endif
endif
...
listvariants:
	@echo VARIANTS COIN bitcoin_testnet bitcoin bitcoin_cash bitcoin_gold litecoin dogecoin dash zcash horizen komodo stratis peercoin pivx viacoin vertcoin stealth digibyte qtum bitcoin_private zcoin gamecredits zclassic xsn nix navcoin
