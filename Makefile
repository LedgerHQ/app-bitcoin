...
# Obsidian 
DEFINES   += COIN_P2PKH_VERSION=75 COIN_P2SH_VERSION=125 COIN_FAMILY=2 COIN_COINID=\"Obsidian\" COIN_COINID_HEADER=\"OBSIDIAN\" COIN_COLOR_HDR=0x35584b COIN_COLOR_DB=0x1fba81 COIN_COINID_NAME=\"Obsidian\" COIN_COINID_SHORT=\"ODN\" COIN_KIND=COIN_KIND_OBSIDIAN COIN_FLAGS=FLAG_PEERCOIN_SUPPORT
APPNAME ="Obsidian"
APP_LOAD_PARAMS += --path $(APP_PATH)
