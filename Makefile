...
# Bitcore
DEFINES   += COIN_P2PKH_VERSION=0 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"Bitcore\" COIN_COINID_HEADER=\"BITCORE\" COIN_COLOR_HDR=0xC831A7 COIN_COLOR_DB=0xce774ce COIN_COINID_NAME=\"Bitcore\" COIN_COINID_SHORT=\"BTX\" COIN_KIND=COIN_KIND_BITCORE COIN_FORKID=0 COIN_FLAGS=FLAG_SEGWIT_CHANGE_SUPPORT
APPNAME ="Bitcore"
APP_LOAD_PARAMS += --path $(APP_PATH)
