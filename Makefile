...
# ECCoin
DEFINES   += BIP44_COIN_TYPE=319 BIP44_COIN_TYPE_2=319 COIN_P2PKH_VERSION=33 COIN_P2SH_VERSION=8 COIN_FAMILY=2 COIN_COINID=\"ECCoin\" COIN_COINID_HEADER=\"ECCOIN\" COIN_COLOR_HDR=0x1685e8 COIN_COLOR_DB=0xffffff COIN_COINID_NAME=\"ECCoin\" COIN_COINID_SHORT=\"ECC\" COIN_KIND=COIN_KIND_ECC COIN_FLAGS=FLAG_PEERCOIN_UNITS
APPNAME ="ECCoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
