...
# Tao
DEFINES   += COIN_P2PKH_VERSION=66 COIN_P2SH_VERSION=3 COIN_FAMILY=1 COIN_COINID=\"Tao\" COIN_COINID_HEADER=\"TAO\" COIN_COLOR_HDR=0x000000 COIN_COLOR_DB=0xFFFFFF COIN_COINID_NAME=\"Tao\" COIN_COINID_SHORT=\"XTO\" COIN_KIND=COIN_KIND_TAO
APPNAME ="Tao"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
