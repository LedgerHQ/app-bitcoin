...
# Tao
DEFINES   += COIN_P2PKH_VERSION=66 COIN_P2SH_VERSION=3 COIN_FAMILY=1 COIN_COINID=\"Tao\" COIN_COINID_HEADER=\"TAO\" COIN_COLOR_HDR=0x000000 COIN_COLOR_DB=0xFFFFFF COIN_COINID_NAME=\"Tao\" COIN_COINID_SHORT=\"Tao\" COIN_KIND=COIN_KIND_TAO
APPNAME ="Tao"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, horizen, komodo, stratis, peercoin, posw, pivx, viacoin, vertcoin, stealth, digibyte, qtum, hcash, bitcoin_private, zcoin, tao) 
endif
endif
...
listvariants:
	@echo VARIANTS COIN bitcoin_testnet bitcoin bitcoin_cash bitcoin_gold litecoin dogecoin dash zcash horizen komodo stratis peercoin posw pivx viacoin vertcoin stealth digibyte qtum hcash bitcoin_private zcoin tao
