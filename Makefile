...
APPNAME ="NIX"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),snowgem)
# Snowgem
DEFINES   += COIN_P2PKH_VERSION=7208 COIN_P2SH_VERSION=7213 COIN_FAMILY=1 COIN_COINID=\"SnowGem\" COIN_COINID_HEADER=\"SNOWGEM\" COIN_COLOR_HDR=0xc87035 COIN_COLOR_DB=0xc78457 COIN_COINID_NAME=\"SnowGem\" COIN_COINID_SHORT=\"XSG\" COIN_KIND=COIN_KIND_SNOWGEM
APPNAME ="SnowGem"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, horizen, komodo, stratis, peercoin, pivx, viacoin, vertcoin, stealth, digibyte, qtum, bitcoin_private, zcoin, gamecredits, zclassic, xsn, nix, snowgem)
endif
endif
...
listvariants:
	@echo VARIANTS COIN bitcoin_testnet bitcoin bitcoin_cash bitcoin_gold litecoin dogecoin dash zcash horizen komodo stratis peercoin pivx viacoin vertcoin stealth digibyte qtum bitcoin_private zcoin gamecredits zclassic xsn nix snowgem
