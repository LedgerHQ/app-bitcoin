...
# Sapphire
DEFINES   += BIP44_COIN_TYPE=832 BIP44_COIN_TYPE_2=832 COIN_P2PKH_VERSION=63 COIN_P2SH_VERSION=18 COIN_FAMILY=1 COIN_COINID=\"Sapphire\" COIN_COINID_HEADER=\"SAPPHIRE\" COIN_COLOR_HDR=0x6666FF COIN_COLOR_DB=0xFFFFFF COIN_COINID_NAME=\"Sapphire\" COIN_COINID_SHORT=\"SAPP\" COIN_KIND=COIN_KIND_SAPPHIRE
APPNAME ="Sapphire"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
