...
APPVERSION_N=2
APPVERSION_P=10
APPVERSION=$(APPVERSION_M).$(APPVERSION_N).$(APPVERSION_P)-zc
...
# Zcash
# Testnet 7461
DEFINES   += COIN_P2PKH_VERSION=7352 COIN_P2SH_VERSION=7357 COIN_FAMILY=1 COIN_COINID=\"Zcash\" COIN_COINID_HEADER=\"ZCASH\" COIN_COLOR_HDR=0x3790CA COIN_COLOR_DB=0x9BC8E5 COIN_COINID_NAME=\"Zcash\" COIN_COINID_SHORT=\"ZEC\" COIN_FORKID=0x76b809bb COIN_KIND=COIN_KIND_ZCASH
APPNAME ="Zcash"
APP_LOAD_PARAMS += --path $(APP_PATH)
