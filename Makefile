...
APP_PATH = ""
# All but counoscoin app use dependency onto the counoscoin app/lib
APP_LOAD_FLAGS=--appFlags 0x50 --dep Counoscoin
DEFINES_LIB = USE_LIB_COUNOSCOIN
...
ifeq ($(COIN),counoscoin_testnet)
# Counoscoin testnet
DEFINES   += COIN_P2PKH_VERSION=111 COIN_P2SH_VERSION=196 COIN_FAMILY=1 COIN_COINID=\"Counoscoin\" COIN_COINID_HEADER=\"COUNOSCOIN\" COIN_COLOR_HDR=0xFCB653 COIN_COLOR_DB=0xFEDBA9 COIN_COINID_NAME=\"Counoscoin\" COIN_COINID_SHORT=\"TEST\" COIN_NATIVE_SEGWIT_PREFIX=\"tb\" COIN_KIND=COIN_KIND_COUNOSCOIN_TESTNET COIN_FLAGS=FLAG_SEGWIT_CHANGE_SUPPORT

APPNAME ="Counoscoin Test"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),counoscoin)
# Counoscoin mainnet
DEFINES   += COIN_P2PKH_VERSION=0 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"Counoscoin\" COIN_COINID_HEADER=\"COUNOSCOIN\" COIN_COLOR_HDR=0xFCB653 COIN_COLOR_DB=0xFEDBA9 COIN_COINID_NAME=\"Counoscoin\" COIN_COINID_SHORT=\"BTC\" COIN_NATIVE_SEGWIT_PREFIX=\"bc\" COIN_KIND=COIN_KIND_COUNOSCOIN COIN_FLAGS=FLAG_SEGWIT_CHANGE_SUPPORT
DEFINES_LIB=# we're not using the lib :)
APPNAME ="Counoscoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
#LIB and global pin and 
APP_LOAD_FLAGS=--appFlags 0x850
else ifeq ($(COIN),counoscoin_cash)
# Counoscoin cash
DEFINES   += COIN_P2PKH_VERSION=0 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"Counoscoin\" COIN_COINID_HEADER=\"COUNOSCOINCASH\" COIN_COLOR_HDR=0x85bb65 COIN_COLOR_DB=0xc2ddb2 COIN_COINID_NAME=\"CounoscoinCash\" COIN_COINID_SHORT=\"BCH\" COIN_KIND=COIN_KIND_COUNOSCOIN_CASH COIN_FORKID=0
APPNAME ="Counoscoin Cash"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),counoscoin_gold)
# Counoscoin Gold 
DEFINES   += COIN_P2PKH_VERSION=38 COIN_P2SH_VERSION=23 COIN_FAMILY=1 COIN_COINID=\"Counoscoin\\x20Gold\" COIN_COINID_HEADER=\"COUNOSCOINGOLD\" COIN_COLOR_HDR=0x85bb65 COIN_COLOR_DB=0xc2ddb2 COIN_COINID_NAME=\"CounoscoinGold\" COIN_COINID_SHORT=\"BTG\" COIN_KIND=COIN_KIND_COUNOSCOIN_GOLD COIN_FLAGS=FLAG_SEGWIT_CHANGE_SUPPORT COIN_FORKID=79
APPNAME ="Counoscoin Gold"
APP_LOAD_PARAMS += --path $(APP_PATH)
...
APPNAME ="Zcoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),counoscoin_private)
# Counoscoin Private
DEFINES   += COIN_P2PKH_VERSION=4901 COIN_P2SH_VERSION=5039 COIN_FAMILY=1 COIN_COINID=\"BPrivate\" COIN_COINID_HEADER=\"COUNOSCOINPRIVATE\" COIN_COLOR_HDR=0x85bb65 COIN_COLOR_DB=0xc2ddb2 COIN_COINID_NAME=\"BPrivate\" COIN_COINID_SHORT=\"BTCP\" COIN_KIND=COIN_KIND_COUNOSCOIN_PRIVATE COIN_FORKID=42
APPNAME ="Counoscoin Private"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported COIN - use counoscoin_testnet, counoscoin, counoscoin_cash, counoscoin_gold, litecoin, dogecoin, dash, zcash, zencash, komodo, stratis, peercoin, posw, pivx, viacoin, vertcoin, stealth, digibyte, qtum, hcash, counoscoin_private) 
endif
endif
