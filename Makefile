...
# Metaverse ETP
DEFINES   += COIN_P2PKH_VERSION=50 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"ETP\" COIN_COINID_HEADER=\"ETP\" COIN_COLOR_HDR=0x326464 COIN_COLOR_DB=0x99b2b2 COIN_COINID_NAME=\"ETP\" COIN_COINID_SHORT=\"ETP\" COIN_KIND=COIN_KIND_ETP
DEFINES_LIB=# we're not using the lib either :)
APPNAME ="ETP"
APP_LOAD_PARAMS += --path $(APP_PATH)
