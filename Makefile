...
APP_LOAD_PARAMS += --path "44'/609'"
# Cducoin mainnet
DEFINES   += BIP44_COIN_TYPE=69 BIP44_COIN_TYPE_2=33 COIN_P2PKH_VERSION=0 COIN_P2SH_VERSION=2 COIN_FAMILY=1 COIN_COINID=\"Cducoin\" COIN_COINID_HEADER=\"CDUCOIN\" COIN_COLOR_HDR=0xFCB653 COIN_COLOR_DB=0xFF0000 COIN_COINID_NAME=\"Cducoin\" COIN_COINID_SHORT=\"CDU\" COIN_NATIVE_SEGWIT_PREFIX=\"cdu\" COIN_KIND=COIN_KIND_CDUCOIN COIN_FLAGS=FLAG_SEGWIT_CHANGE_SUPPORT
APPNAME ="Cducoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, horizen, komodo, stratis, peercoin, pivx, viacoin, vertcoin, stealth, digibyte, qtum, bitcoin_private, firo, gamecredits, zclassic, xsn, nix, lbry, resistance, ravencoin, hydra, hydra_testnet, cducoin)
endif
endif
